...
def parse_args():
    ...
    parser.add_argument("--dataset_type", type=str, default="CustomDataset", help="CustomDataset of the dataset to use")
...
def main():
    ...
    train_dataset = load_dataset(args.dataset_name, tokenizer, args.dataset_type, num_processes = trainer.accelerator.num_processes, process_index = trainer.accelerator.process_index, mel_spec_kwargs=mel_spec_kwargs)
